...
vim.keymap.set("n", "<LEADER>s", "<CMD>lua require('substitute.range').operator()<CR>", { desc = "swap in range" })
vim.keymap.set("x", "<LEADER>s", "<CMD>lua require('substitute.range').visual()<CR>", { desc = "visual mode swap in range" })
vim.keymap.set("n", "<LEADER>ss", "<CMD>lua require('substitute.range').word()<CR>", { desc = "swap word in range" })
